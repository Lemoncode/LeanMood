...
export const adminActionEnums = {
  ...
  GET_STUDENT_REQUEST_COMPLETED: 'GET_STUDENT_REQUEST_COMPLETED',
  POST_STUDENT_REQUEST_COMPLETED: 'POST_STUDENT_REQUEST_COMPLETED',
  EDIT_STUDENT_CONTENT_CHANGED: 'EDIT_STUDENT_CONTENT_CHANGED',
};
