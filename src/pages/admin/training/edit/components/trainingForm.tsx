                            ...
                            <form className="form-horizontal">
                                <div className="form-group">
                                    ...
                                    <div className="col-md-11 col-xs-12">
                                        <input type="text" className="form-control" id="name" value={props.training.name} />
                                    </div>
                                </div>
                                <div className="form-group">
                                    <label className="control-label col-md-1 col-xs-12">start</label>
                                    <div className="col-md-3 col-xs-12">
                                        <input type="date" className="form-control" id="start" value={props.training.start.toDateString()} />
                                    </div>
                                    <label className="control-label col-md-1 col-xs-12">end</label>
                                    <div className="col-md-3 col-xs-12">
                                        <input type="date" className="form-control" id="end" value={props.training.end.toDateString()} />
                                    </div>
                                </div>
                                <div className="form-group">
                                    <div className="col-md-12 col-xs-12">
                                        <div className="checkbox">
                                            <label><input type="checkbox" checked={props.training.isActive} /> is Active</label>
                                        </div>
                                    </div>
                                </div>
                            </form>
